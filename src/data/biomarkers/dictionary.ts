...
const urinalysisBiomarkers: BiomarkerDefinition[] = [
  ...
  {
    name: 'Urine Glucose',
    aliases: ['Glucose', 'Glycosuria', 'Urine Sugar', 'Urine Glucosio', 'Glucosio Urinario', 'U-Glucosio', 'Glucosio (urine)'],
    category: 'urinalysis',
    canonicalUnit: 'mg/dL',
    alternativeUnits: ['mmol/L'],
  ...
  },
  {
    ...
    aliases: ['U-Creatinina', 'Creatinina urinaria', 'Creatinina (urine)', 'U-Creatinina urinaria prima minzione', 'Creatinina urinaria prima minzione'],
    category: 'urinalysis',
    canonicalUnit: 'mg/dL',
  ...
  },
  {
    ...
    aliases: ['U-VOLUME (24h)', 'Urine Volume 24h', '24h Urine Volume', 'Diuresi 24h', 'Volume urinario 24h'],
    category: 'urinalysis',
    canonicalUnit: 'mL',
...
const proteinElectrophoresisBiomarkers: BiomarkerDefinition[] = [
  ...
  {
    name: 'Beta Globulin',
    aliases: ['S-Elettroforesi beta', 'Elettroforesi beta', 'Beta globulina', 'β-Globulin', 'Beta'],
    category: 'metabolic',
    canonicalUnit: '%',
    alternativeUnits: ['g/dL', 'g/L'],
  ...
  {
    name: 'Gamma Globulin',
    aliases: ['S-Elettroforesi gamma', 'Elettroforesi gamma', 'Gamma globulina', 'γ-Globulin', 'Gamma', 'Immunoglobulins'],
    category: 'metabolic',
    canonicalUnit: '%',
    alternativeUnits: ['g/dL', 'g/L'],
