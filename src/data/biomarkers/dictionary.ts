...
const metabolicBiomarkers: BiomarkerDefinition[] = [
  {
    name: 'Glucose',
    aliases: ['Blood Sugar', 'Fasting Glucose', 'FBG', 'Blood Glucose', 'Glucosio', 'S-Glucosio', 'Glicemia'],
    category: 'metabolic',
    canonicalUnit: 'mg/dL',
...
const lipidBiomarkers: BiomarkerDefinition[] = [
  ...
  {
    name: 'Triglycerides',
    aliases: ['TG', 'Trigs', 'TRIG', 'Trigliceridi', 'S-Trigliceridi'],
    category: 'lipid',
    canonicalUnit: 'mg/dL',
    alternativeUnits: ['mmol/L'],
...
const urinalysisBiomarkers: BiomarkerDefinition[] = [
  ...
  },
  {
    ...
    aliases: ['Specific Gravity', 'SG', 'Urine SG', 'Urine Densità', 'Densità Urinaria', 'Peso Specifico'],
    category: 'urinalysis',
    canonicalUnit: '',
    alternativeUnits: [],
  ...
  {
    name: 'Urine Glucose',
    aliases: ['Glucose', 'Glycosuria', 'Urine Sugar', 'Urine Glucosio', 'Glucosio Urinario'],
    category: 'urinalysis',
    canonicalUnit: 'mg/dL',
    alternativeUnits: ['mmol/L'],
  ...
  {
    name: 'Urine Ketones',
    aliases: ['Ketones', 'Ketonuria', 'Corpi Chetonici', 'Corpi Chetonici (urine)', 'Chetoni'],
    category: 'urinalysis',
    canonicalUnit: 'mg/dL',
    alternativeUnits: ['mmol/L'],
  ...
  {
    name: 'Urine Blood',
    aliases: ['Blood', 'Hematuria', 'RBC in Urine', 'Eritrociti (urine)', 'Eritrociti Urine', 'Emazie Urine'],
    category: 'urinalysis',
